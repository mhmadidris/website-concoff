...
<aside class="z-20 flex-shrink-0 hidden w-64 overflow-y-auto bg-white md:block" aria-label="aside">
    <div class="text-serv-bg">
        ...
        <div class="">
            ...
            <a href="/">
                <img style="margin: auto;" class="py-10" src="{{ asset('concoff/Logo_concoff.svg') }}" alt="main-logo" width="100" />
            </a>
        ...
        <ul>
            ...
            <li class="relative px-6 py-3">
                ...
                <a class="inline-flex items-center w-full text-sm font-medium transition-colors duration-150 hover:text-gray-800 " href="{{ route('dashboard.article.index') }}">

                    <!-- Active Icons -->
                    <img src="{{ asset('concoff/coupon_bold.png') }}" style="width: 24px; height:24px;" />
                    <span class="ml-4">Voucher</span>

                </a>
                @else
                <a class="inline-flex items-center w-full text-sm font-light transition-colors duration-150 hover:text-gray-800" href="{{ route('dashboard.article.index') }}">
                    <img src="{{ asset('concoff/coupon.png') }}" style="width: 24px; height:24px;" />
                    <span class="ml-4">Voucher</span>
                </a>
                @endif
            </li>
            ...
            <li class="relative px-6 py-3">
                ...
                <a class="inline-flex items-center w-full text-sm font-medium transition-colors duration-150 hover:text-gray-800 " href="{{ route('dashboard.product.index') }}">
